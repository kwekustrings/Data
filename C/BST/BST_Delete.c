...
found in that tree. Note that the entire tree does not need to 
be searched. */
...
struct node* deleteNode(struct node* root, int key)
{
    ...
    //If the key to deleted is smaller than the root's key.
    ...
    else
    {
        ...
        //node with two children: Get the inorder succesor (smallerst)
